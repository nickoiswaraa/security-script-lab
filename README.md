...
awk '{print $1}' $LOG:
```
Membaca file log yang dituju dan mengekstrak/mengambil kolom pertama ($1) dari setiap baris teks. Dalam format log standar (seperti log web server atau log SSH), kolom pertama biasanya adalah alamat IP (IP address).
